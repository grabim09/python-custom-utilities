...
def parse_duration(duration_in_seconds:float=0) -> str:
    ...
    elif duration_in_seconds < 1: return format_float(duration_in_seconds*1000)+'ms'
    elif duration_in_seconds < 60: return format_float(duration_in_seconds)+'s'
    ...
    if duration_in_hours != 0: duration_parameters.append(str(int(duration_in_hours))+'h')
    if duration_in_minutes != 0: duration_parameters.append(str(int(duration_in_minutes))+'m')
    if duration_in_seconds != 0: duration_parameters.append(str(int(duration_in_seconds))+'s')
    if duration_in_milliseconds != 0: duration_parameters.append(str(int(duration_in_milliseconds))+'ms')
